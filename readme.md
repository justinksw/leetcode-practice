...
As for the l1 = [2, 4, 3], define it as a linked list will be like:
...
class Solution:
    def addTwoNumbers(self, l1: Optional[ListNode], l2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        # "current" used as a pointer, at the Root (dummy head) in begining.
        current = dummy_head
        
        carry = 0  # mark for 進位

        # Looping the linked list from Root (Head) to End (Tail).
...
# # Output: 807 (represented as 7 -> 0 -> 8)
# while result:
